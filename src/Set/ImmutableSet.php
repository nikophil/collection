 ...
 */
interface ImmutableSet extends Set, ImmutableCollection
{
	/**
	 * {@inheritDoc}
	 *
	 * @deprecated You are using toImmutable() on an ImmutableSet!
	 ...
	 * @return ImmutableSet<E|NE> A new collection with the element added
	 */
	#[NoDiscard]
	 ...
	 *
	 * @param NE $element The element to add
	 * @return ImmutableSet<E|NE> A new collection with the element first
	 */
	#[NoDiscard]
	 ...
	 * @return ImmutableSet<E|NE> A new collection with the elements added
	 */
	#[NoDiscard]
	 ...
	 * @return ImmutableSet<E> The new immutable collection
	 */
	#[NoDiscard]
