...
final class ImmutableMapEntrySetTest extends AbstractSetTestCase
{
	/**
	 * @template E
	...
	{
		return mapOf($data)->entries->map(fn ($entry) => $entry->value); // @phpstan-ignore argument.templateType
	}
