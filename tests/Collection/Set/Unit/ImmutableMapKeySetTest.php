...
final class ImmutableMapKeySetTest extends AbstractSetTestCase
{
	/**
	 * @template E
	...
	{
		return mapOf($data)->flip(KeyCollisionStrategy::KeepLast)->keys; // @phpstan-ignore argument.templateType
	}
